 <div class="menu container frame nofloat">
	...
	<div class="menu--items menu-lvl-1 js-menu-lvl-1 col-lg-6 col-md-12 col-sm-12">
		...
		<div class="menu--items--item col-lg-4 col-md-12 col-sm-12">	
			<h3 class="menu--items--item--link">Mood</h3>
		</div>
		<div class="menu--items--item col-lg-4 col-md-12 col-sm-12">	
			<h3 class="menu--items--item--link">About</h3>
		</div>
	</div>
	...
	<div class="menu--items menu-lvl-2 js-menu-lvl-2 col-lg-12 col-md-12 col-sm-12">
		...
		<div class="menu--items--item col-lg-2 col-md-12 col-sm-12">	
			<h4 class="menu--items--item--link">Grafic Design</h4>
		</div>
		<div class="menu--items--item col-lg-2 col-md-12 col-sm-12">	
			<h4 class="menu--items--item--link">Textil Design</h4>
		</div>
		<div class="menu--items--item col-lg-2 col-md-12 col-sm-12">	
			<h4 class="menu--items--item--link">Surface Design</h4>
		</div>
		<div class="menu--items--item col-lg-2 col-md-12 col-sm-12">	
			<h4 class="menu--items--item--link">Interior Design</h4>
		</div>
		<div class="menu--items--item col-lg-2 col-md-12 col-sm-12">	
			<h4 class="menu--items--item--link">Concepting & Trend</h4>
		</div>
		<div class="menu--items--item col-lg-1 col-md-12 col-sm-12">	
			<h4 class="menu--items--item--link">Product Design</h4>
		</div>
		<div class="menu--items--item col-lg-1 col-md-12 col-sm-12">	
