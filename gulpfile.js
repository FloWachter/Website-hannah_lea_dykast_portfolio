...
gutil.log(gutil.colors.inverse('joachim@ansich.ch'));
...
gulp.task('default', function() {
    ...
    // Watch JS
    gulp.watch(devAssets + 'js/*.js', ['uglifyjs']);

    // Watch Vendor JS
    gulp.watch(devAssets + 'js/vendor/*.js', ['vendorJS']);
